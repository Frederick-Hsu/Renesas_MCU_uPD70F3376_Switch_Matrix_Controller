/********************************************************************************************
 * Program name	: memory_space_mapping_caution.h
 * Description	: This file is just to caution the memory mapping, when you want to allocate
 *		: some memory space.
 *		: It is global.
 * Author	: XU ZAN
...
#ifndef _MEMORY_SPACE_MAPPING_CAUTION_H
#define _MEMORY_SPACE_MAPPING_CAUTION_H
...
#endif	/*    _MEMORY_SPACE_MAPPING_CAUTION_H    */
